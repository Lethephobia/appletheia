...
pub struct EventOutboxPublishedAt(DateTime<Utc>);

impl EventOutboxPublishedAt {
    pub fn now() -> Self {
        Self(Utc::now())
    }
...
impl Default for EventOutboxPublishedAt {
    fn default() -> Self {
        Self::now()
    }
}

impl From<DateTime<Utc>> for EventOutboxPublishedAt {
    fn from(value: DateTime<Utc>) -> Self {
        Self(value)
    }
}

impl From<EventOutboxPublishedAt> for DateTime<Utc> {
    fn from(value: EventOutboxPublishedAt) -> Self {
        value.0
    }
}

impl Display for EventOutboxPublishedAt {
...
mod tests {
    ...
    fn value_returns_inner_datetime() {
        ...
        let published_at = EventOutboxPublishedAt::from(timestamp);
    ...
    fn conversions_round_trip() {
        ...
        let published_at: EventOutboxPublishedAt = timestamp.into();

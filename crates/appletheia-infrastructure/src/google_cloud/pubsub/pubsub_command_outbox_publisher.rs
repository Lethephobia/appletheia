...
use appletheia_application::command::{
    CommandOutbox, CommandOutboxDispatchError, CommandOutboxPublishResult, CommandOutboxPublisher,
    CommandOutboxPublisherError,
};
...
impl PubsubCommandOutboxPublisher {
    ...
    fn build_message(outbox: &CommandOutbox) -> Result<PubsubMessage, CommandOutboxPublisherError> {
            ...
            match awaiter.get().await {
                ...
                Err(status) => {
                    ...
                    let cause = match status.code() {
                        ...
                        | Code::Aborted => CommandOutboxDispatchError::Transient {
                            code: code.clone(),
                            message,
                        },
                        _ => CommandOutboxDispatchError::Permanent { code, message },
                    };

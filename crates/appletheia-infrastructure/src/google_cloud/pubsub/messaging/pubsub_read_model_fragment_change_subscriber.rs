...
pub struct PubsubReadModelFragmentChangeSubscriber {
...
impl PubsubReadModelFragmentChangeSubscriber {
    pub fn new(
        subscriber: GoogleSubscriber,
        subscription_admin: SubscriptionAdmin,
        subscription_path_prefix: PubsubSubscriptionPathPrefix,
...
impl Subscriber<ReadModelFragmentChangeEnvelope> for PubsubReadModelFragmentChangeSubscriber {
    type Consumer = PubsubConsumer<ReadModelFragmentChangeEnvelope>;
    type Selector = ReadModelFragmentChangeShard;
    ...
    async fn subscribe(
        ...
        let filter = format!(
            "attributes.{} = \"{}\"",
            ReadModelFragmentChangeShard::ATTRIBUTE_NAME,

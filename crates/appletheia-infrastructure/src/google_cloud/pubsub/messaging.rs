...
pub mod pubsub_read_model_fragment_change_publisher;
pub mod pubsub_read_model_fragment_change_subscriber;
...
pub use pubsub_read_model_fragment_change_publisher::PubsubReadModelFragmentChangePublisher;
pub use pubsub_read_model_fragment_change_subscriber::PubsubReadModelFragmentChangeSubscriber;

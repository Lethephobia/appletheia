...
use appletheia_application::event::{
    AggregateTypeOwnedError, EventOutboxAttemptCountError, EventOutboxIdError,
    EventOutboxRelayInstanceError, EventPayloadOwnedError, EventSequenceError,
};
...
pub enum PgEventOutboxRowError {
    ...
    LeaseOwner(#[from] EventOutboxRelayInstanceError),

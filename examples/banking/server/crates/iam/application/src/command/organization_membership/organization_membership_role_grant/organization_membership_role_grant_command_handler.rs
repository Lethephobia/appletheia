...
impl<ORG, MR> OrganizationMembershipRoleGrantCommandHandler<ORG, MR>
where
    ORG: Repository<Organization>,
    MR: Repository<OrganizationMembership, Uow = ORG::Uow>,
{
...
impl<ORG, MR> CommandHandler for OrganizationMembershipRoleGrantCommandHandler<ORG, MR>
where
    ORG: Repository<Organization>,
    MR: Repository<OrganizationMembership, Uow = ORG::Uow>,
{
    ...
    type ReplayOutput = OrganizationMembershipRoleGrantOutput;
    ...
    async fn handle(
        ...
        let Some(mut organization_membership) = self
            ...
            return Err(
                OrganizationMembershipRoleGrantCommandHandlerError::TargetOrganizationMembershipNotFound,
            );
        };
        ...
        let Some(organization) = self
            ...
            return Err(OrganizationMembershipRoleGrantCommandHandlerError::OrganizationNotFound);
        };
...
mod tests {
    ...
    #[test]
    fn authorization_plan_requires_role_granter_relationship() {
        ...
        let handler = OrganizationMembershipRoleGrantCommandHandler::new(
            organization_repository,
            organization_membership_repository,
        );
        ...
        let plan = handler
            .authorization_plan(&OrganizationMembershipRoleGrantCommand {
    ...
    #[tokio::test]
    async fn handle_grants_role_and_returns_output() {
        ...
        let handled = handler
            .handle(
                &mut uow,
                &request_context(),
                &OrganizationMembershipRoleGrantCommand {
                    organization_membership_id,
                    role: OrganizationRole::FinanceManager,
                },
            )

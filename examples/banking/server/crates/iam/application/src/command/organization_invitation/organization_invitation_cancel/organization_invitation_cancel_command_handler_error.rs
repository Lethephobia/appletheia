...
/// Represents errors returned while canceling an organization invitation.
#[derive(Debug, Error)]
pub enum OrganizationInvitationCancelCommandHandlerError {
...
impl Retryability for OrganizationInvitationCancelCommandHandlerError {

...
use banking_iam_application::{
    OrganizationInvitationViewStore, OrganizationInvitationViewStoreError,
...
/// PostgreSQL-backed organization invitation view store.
pub struct PgOrganizationInvitationViewStore;

impl PgOrganizationInvitationViewStore {
    pub fn new() -> Self {
        Self
    }
...
impl Default for PgOrganizationInvitationViewStore {
    fn default() -> Self {
        Self::new()
    }
}

impl OrganizationInvitationViewStore for PgOrganizationInvitationViewStore {
    ...
    async fn upsert(
        ...
        .await
        .map_err(|e| OrganizationInvitationViewStoreError::Persistence(Box::new(e)))?;

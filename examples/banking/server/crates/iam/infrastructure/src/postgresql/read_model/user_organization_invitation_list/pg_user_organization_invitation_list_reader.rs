...
use banking_iam_application::{
    ...
    UserOrganizationInvitationListItemStatus, UserOrganizationInvitationListReader,
...
impl PgUserOrganizationInvitationListReader {
    ...
    fn push_status_filter(
        ...
        statuses: &[UserOrganizationInvitationListItemStatus],
    ) {
    ...
    async fn read_user(
        ...
        let row = sqlx::query_as::<_, PgUserOrganizationInvitationListUserRow>(
            ...
            SELECT user_id, username, display_name, picture_type, picture_object_name,
              ...
              FROM user_organization_invitation_list_users
             WHERE user_id = $1
            "#,
        )
        .bind(user_id.value())
...
impl UserOrganizationInvitationListReader for PgUserOrganizationInvitationListReader {
    ...
    async fn list(
        ...
        let sort_key = cursor_options
            ...
            .unwrap_or(UserOrganizationInvitationListSortKey::CreatedAt);
        ...
        let mut builder = QueryBuilder::<Postgres>::new(
            ...
            FROM user_organization_invitation_list_items AS i
            INNER JOIN user_organization_invitation_list_organizations AS o

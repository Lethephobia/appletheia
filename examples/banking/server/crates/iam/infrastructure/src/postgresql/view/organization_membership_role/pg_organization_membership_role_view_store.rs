...
use banking_iam_application::{
    OrganizationMembershipRoleViewStore, OrganizationMembershipRoleViewStoreError,
    OrganizationMembershipRoleViewUpsert,
};
use banking_iam_domain::{OrganizationMembershipId, OrganizationRole};

/// PostgreSQL-backed membership role view store.
pub struct PgOrganizationMembershipRoleViewStore;

impl PgOrganizationMembershipRoleViewStore {
    pub fn new() -> Self {
        Self
    }
...
impl Default for PgOrganizationMembershipRoleViewStore {
    fn default() -> Self {
        Self::new()
    }
}

impl OrganizationMembershipRoleViewStore for PgOrganizationMembershipRoleViewStore {
    ...
    async fn upsert(
        ...
        .await
        .map_err(|e| OrganizationMembershipRoleViewStoreError::Persistence(Box::new(e)))?;

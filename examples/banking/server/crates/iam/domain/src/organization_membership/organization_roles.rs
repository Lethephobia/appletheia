...
/// Declares the elevated roles granted inside an organization.
...
impl OrganizationRoles {
    ...
    /// Returns whether the set contains the given role.
...
impl IntoIterator for OrganizationRoles {
...
impl<'a> IntoIterator for &'a OrganizationRoles {
...
impl Hash for OrganizationRoles {
...
mod tests {
    ...
    fn normalizes_duplicate_roles_into_sorted_set() {
        let roles = OrganizationRoles::new([
    ...
    fn serializes_to_json_array() {
        let roles =
            OrganizationRoles::new([OrganizationRole::Admin, OrganizationRole::FinanceManager]);

...
/// PostgreSQL-backed transfer projection store.
pub struct PgTransferProjectionStore;

impl PgTransferProjectionStore {
    pub fn new() -> Self {
        Self
    }
...
impl Default for PgTransferProjectionStore {
    fn default() -> Self {
        Self::new()
    }
}

impl TransferProjectionStore for PgTransferProjectionStore {
    ...
    async fn upsert(
        ...
        sqlx::query(
            ...
            INSERT INTO transfers (
                id, from_account_id, to_account_id, amount, status, created_at, updated_at, updated_event_sequence
            )
        ...
        .await
        .map_err(|e| TransferProjectionStoreError::Persistence(Box::new(e)))?;
        Ok(())
    }

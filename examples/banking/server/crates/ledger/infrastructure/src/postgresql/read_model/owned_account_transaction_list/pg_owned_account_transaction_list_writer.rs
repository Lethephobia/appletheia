...
/// PostgreSQL-backed owned account transaction list writer.
pub struct PgOwnedAccountTransactionListWriter;

impl PgOwnedAccountTransactionListWriter {
    pub fn new() -> Self {
        Self
    }
...
impl Default for PgOwnedAccountTransactionListWriter {
    fn default() -> Self {
        Self::new()
    }
}

impl OwnedAccountTransactionListWriter for PgOwnedAccountTransactionListWriter {
    ...
    async fn delete_owner_user(
        ...
        sqlx::query(
            r#"
            DELETE FROM owned_account_transaction_list_owner_users
             WHERE id = $1 AND updated_event_sequence < $2
            "#,
        )
        .bind(id.value())
    ...
    async fn delete_owner_organization(
        ...
        sqlx::query(
            r#"
            DELETE FROM owned_account_transaction_list_owner_organizations
             WHERE id = $1 AND updated_event_sequence < $2
            "#,
        )
        .bind(id.value())

...
pub use currency::{
    ...
    CurrencyImageChangeCommandHandlerError, CurrencyImageChangeOutput, CurrencyNameChangeCommand,
    CurrencyNameChangeCommandHandler, CurrencyNameChangeCommandHandlerError,
    CurrencyNameChangeOutput, CurrencyOwnershipTransferCommand,

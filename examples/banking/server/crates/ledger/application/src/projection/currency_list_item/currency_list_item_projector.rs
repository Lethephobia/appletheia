...
use super::{CurrencyListItemProjectorError, CurrencyListItemProjectorSpec};
use crate::read_model::{CurrencyListItemStatus, CurrencyListItemWriter};

/// Projects currency events into currency list item read models.
pub struct CurrencyListItemProjector<W>
where
    W: CurrencyListItemWriter,
{
    writer: W,
}

impl<W> CurrencyListItemProjector<W>
where
    W: CurrencyListItemWriter,
{
...
impl<W> Projector for CurrencyListItemProjector<W>
where
    W: CurrencyListItemWriter,
{
    type Spec = CurrencyListItemProjectorSpec;
    type Uow = W::Uow;
    type Error = CurrencyListItemProjectorError;

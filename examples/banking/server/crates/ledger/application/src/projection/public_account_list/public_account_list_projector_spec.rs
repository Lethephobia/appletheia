...
/// Projector specification for public account list read models.
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
pub struct PublicAccountListProjectorSpec;

impl ProjectorSpec for PublicAccountListProjectorSpec {
    const DESCRIPTOR: ProjectorDescriptor = ProjectorDescriptor::new(
        ProjectorName::new("public_account_list"),
        Subscription::AnyOf(&[

...
/// Projector specification for owned account list read models.
#[derive(Copy, Clone, Debug, Eq, PartialEq, Hash)]
pub struct OwnedAccountListProjectorSpec;

impl ProjectorSpec for OwnedAccountListProjectorSpec {
    const DESCRIPTOR: ProjectorDescriptor = ProjectorDescriptor::new(
        ProjectorName::new("owned_account_list"),
        Subscription::AnyOf(&[

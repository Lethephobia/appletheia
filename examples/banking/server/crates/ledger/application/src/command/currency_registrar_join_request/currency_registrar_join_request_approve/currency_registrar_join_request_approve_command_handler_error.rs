...
/// Represents errors returned while approving an currency registrar join request.
#[derive(Debug, Error)]
pub enum CurrencyRegistrarJoinRequestApproveCommandHandlerError {
...
impl Retryability for CurrencyRegistrarJoinRequestApproveCommandHandlerError {

...
/// Represents errors returned while releasing reserved currency supply.
#[derive(Debug, Error)]
pub enum CurrencySupplyReleaseCommandHandlerError {
...
impl Retryability for CurrencySupplyReleaseCommandHandlerError {

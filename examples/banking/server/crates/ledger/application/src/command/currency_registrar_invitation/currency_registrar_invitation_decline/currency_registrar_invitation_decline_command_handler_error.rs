...
/// Represents errors returned while declining an currency registrar invitation.
#[derive(Debug, Error)]
pub enum CurrencyRegistrarInvitationDeclineCommandHandlerError {
...
impl Retryability for CurrencyRegistrarInvitationDeclineCommandHandlerError {

    ...
    AR: Repository<Account>,
{
    ...
    fn on_failure(
        ...
        match &command.context {
            AccountReleaseReservedFundsContext::Transfer { transfer_id } => {
                CommandFailureReaction::with_command(&TransferFailCommand {
                    transfer_id: *transfer_id,
                })
            }
            AccountReleaseReservedFundsContext::Direct => Ok(CommandFailureReaction::None),
        }
    }
...
mod tests {
    ...
    use super::{
        ...
        AccountReleaseReservedFundsCommandHandlerError, AccountReleaseReservedFundsContext,
    };
    use crate::command::TransferFailCommand;
    ...
    fn on_failure_enqueues_transfer_fail_for_transfer_context() {
        let handler = AccountReleaseReservedFundsCommandHandler::new(TestRepository);

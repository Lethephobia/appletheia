    ...
    OACR: Repository<OwnedAccountClosure>,
{
    ...
    type ReplayOutput = OwnedAccountClosureCompleteOutput;
    ...
    async fn handle(
        ...
        let Some(mut owned_account_closure) = self
            ...
            return Err(
                OwnedAccountClosureCompleteCommandHandlerError::OwnedAccountClosureNotFound,
            );
        };
        ...
        Ok(CommandHandled::same(
            OwnedAccountClosureCompleteOutput::from(result),
        ))
    }
}

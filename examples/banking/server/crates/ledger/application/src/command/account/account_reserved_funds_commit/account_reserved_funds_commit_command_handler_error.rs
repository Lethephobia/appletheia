...
/// Represents errors returned while committing reserved funds in an account.
#[derive(Debug, Error)]
pub enum AccountReservedFundsCommitCommandHandlerError {
...
impl Retryability for AccountReservedFundsCommitCommandHandlerError {

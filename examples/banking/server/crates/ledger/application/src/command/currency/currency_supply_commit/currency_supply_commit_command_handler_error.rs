...
/// Represents errors returned while committing reserved currency supply.
#[derive(Debug, Error)]
pub enum CurrencySupplyCommitCommandHandlerError {
...
impl Retryability for CurrencySupplyCommitCommandHandlerError {

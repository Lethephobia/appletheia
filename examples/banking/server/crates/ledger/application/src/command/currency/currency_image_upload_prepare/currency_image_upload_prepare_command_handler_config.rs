...
/// Configuration for `CurrencyImageUploadPrepareCommandHandler`.
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct CurrencyImageUploadPrepareCommandHandlerConfig {
...
impl CurrencyImageUploadPrepareCommandHandlerConfig {
    /// Creates a new `CurrencyImageUploadPrepareCommandHandler` configuration.
    pub fn new(
        bucket_name: ObjectBucketName,
        expires_in: ObjectUploadExpiresIn,
        max_content_length: ObjectContentLength,

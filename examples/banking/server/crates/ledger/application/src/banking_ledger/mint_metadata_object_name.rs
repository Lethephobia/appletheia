...
use crate::banking_ledger::MintId;
...
impl MintMetadataObjectName {
    pub fn new(mint_id: &MintId) -> Self {
        Self(format!("currencies/{}/mint/metadata.json", mint_id.value()))
    }
...
mod tests {
    ...
    fn new_builds_deterministic_metadata_object_name() {
        ...
        let object_name = MintMetadataObjectName::new(&mint_id);
